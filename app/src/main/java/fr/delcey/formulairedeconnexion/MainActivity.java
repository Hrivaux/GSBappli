                ...
                response -> {
                    ...
                    try {
                        ...
                        if (status == HttpURLConnection.HTTP_OK) {
                            ...
                            Toast.makeText(MainActivity.this, "Email ou mot de passe inccorect ", Toast.LENGTH_LONG).show();
                        }
                    } catch (JSONException e) {
                        e.printStackTrace();
                        Toast.makeText(MainActivity.this, "Échec de l'analyse de la réponse du serveur", Toast.LENGTH_LONG).show();
                    }
                },
                error -> {
                    progressDialog.dismiss();
                    error.printStackTrace();
                    Toast.makeText(MainActivity.this, "Échec de connexion au serveur. S'il vous plaît, vérifiez votre connexion à internet et réessayez.", Toast.LENGTH_LONG).show();
                }
        ) {
            @Override
